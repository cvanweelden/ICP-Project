function [mean_diff_t mean_diff_q] = mean_true_diff_at_offset(eval_file)
...
for i = 1:max_offset
    transformation_q_at_i = quatnormalize(results.true_transformation_q(results.offset == i,:));
    ...
    transformation_t_at_i = results.true_transformation_t(results.offset == i,:);
