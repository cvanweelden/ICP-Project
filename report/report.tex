...
Figure \ref{accumulated_rotation_error} shows the accumulated error in orientation after registering frames over 1 second for both datasets. It shows that increasing the number of frames skipped reduces the accumulated error for the feature-based methods (FPFH


%\begin{figure}[htbp]
%    \centering
%        \includegraphics[height=4cm]{ims/ WELKE
%    \caption{The PFH dependency diagram (image from \cite{rusu2009fast}). It indicates that every pair of points in the neighborhood generates features.}
